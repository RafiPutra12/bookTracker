        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.update', $book->id) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div>
                            <x-input-label for="year" value="Released Year" />
                            <x-text-input id="year" name="year" type="text" class="mt-1 block w-full" :value="$book->year ?? old('year')" required autofocus />
                            <x-input-error class="mt-2" :messages="$errors->get('year')" />
                        </div>
                        <div>
                            <x-input-label for="copies" value="Release Copies" />
